...
require_once HAL_CARTEL_PLUGIN_DIR . 'includes/class-hal-cartel-currency.php';
require_once HAL_CARTEL_PLUGIN_DIR . 'includes/class-hal-cartel-shipping.php';
require_once HAL_CARTEL_PLUGIN_DIR . 'includes/class-hal-cartel-product.php';
require_once HAL_CARTEL_PLUGIN_DIR . 'includes/class-hal-cartel-product-variation.php';
...
require_once HAL_CARTEL_PLUGIN_DIR . 'includes/class-hal-cartel-payment-events.php';
require_once HAL_CARTEL_PLUGIN_DIR . 'includes/class-hal-cartel-emails.php';
require_once HAL_CARTEL_PLUGIN_DIR . 'includes/class-hal-cartel-downloads.php';
require_once HAL_CARTEL_PLUGIN_DIR . 'includes/class-hal-cartel-mailchimp.php';
...
require_once HAL_CARTEL_PLUGIN_DIR . 'includes/class-hal-cartel-gateways.php';
require_once HAL_CARTEL_PLUGIN_DIR . 'includes/gateways/class-hal-cartel-gateway-manual.php';
require_once HAL_CARTEL_PLUGIN_DIR . 'includes/gateways/class-hal-cartel-gateway-stripe.php';
